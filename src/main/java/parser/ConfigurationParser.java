...
public class ConfigurationParser {
	...
	// cross over names
	private static final String CROSS_OVER1 = "cruza1";

	// mutation algorithm names
	private static final String MUTATION1 = "mutacion1";
	...
	private static void handleCrossOverAlgorithm(Map<String, String> configurationMap, Configuration.Builder builder) {
		...
		builder.withCrossOverAlgorithm(createCrossOverAlgorithm(type, configurationMap), getPC(configurationMap));
	}
	...
	private static void handleMutationAlgorithm(Map<String, String> configurationMap, Configuration.Builder builder) {
		...
		builder.withMutationAlgorithm(createMutationAlgorithm(name, configurationMap), getPM(configurationMap));
	}
	...
	private static double getPC(Map<String, String> configurationMap) {
		return Double.valueOf(getValue(configurationMap, TC_PC));
	}
	...
	private static CrossOverAlgorithm createCrossOverAlgorithm(String crossOverAlgorithmName,
		...
		case CROSS_OVER1:
			return new GAPACrossOver2();
		default:
			return null;
		}
	}

	private static double getPM(Map<String, String> configurationMap) {
		return Double.valueOf(getValue(configurationMap, AM_PM));
	}
	...
	private static MutationAlgorithm createMutationAlgorithm(String mutationAlgorithmName,
		...
		case MUTATION1:
			return new GAPAMutationAlgorithm2();
		default:
			return null;
		}
	}
